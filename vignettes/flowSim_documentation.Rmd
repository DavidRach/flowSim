...
paths_plots<-list.files(path = fpath,full.names = TRUE)
...
# Analyze only 2nd and 3rd file path: based on list.files(fpath,full.names=TRUE)
...
plot_visnet(visnetdata,remove_single_files = TRUE) # \donotrun.
...
visnetdata_contracted<-gen_visnetwork_data(igraph_network,contract_net = TRUE) # \donotrun.
